            ...
            switch(credType) {
                ...
                case ssh:
                    ...
                    if (handler.getPath() == null) {
                        throw new CondorStyleException("Remote Exec. Unable to find required credential for file transfers. " +
        ...
        while (iter.hasNext()) {
            ...
            switch(credType) {
                ...
                case ssh:
                    ...
                    if (handler.getPath() == null) {
                        throw new CondorStyleException("Local Exec. Unable to find required credential for file transfers. " +
                                                       "Please make sure " + handler.getEnvironmentVariable() +
                                                       " is set either in the site catalog or your environment." + " The handler is "+handler.getDescription());
                    }
