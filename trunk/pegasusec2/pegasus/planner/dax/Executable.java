...
public class Executable extends CatalogType {
    ...
    /**
     * Amelie: the amazon ec2 instance type types
     * */
    ...
    protected OS mOs;
    /**
     * Amelie: the amazon ec2 instance type the executable is compiled for
     * */
    ...
    public Executable(Executable e) {
        ...
        this.mArch = e.mArch;
        this.mOs = e.mOs;
        this.mInstanceType = e.mInstanceType;
    ...
    * Same as add Notification
    ...
    /**
     * Set the amazon ec2 instance type the executable is compiled for
     * @param type
     * @return Executable
     */
    public Executable setInstancetype(INSTANCETYPE type) {
        mInstanceType = type;
        return this;
    }
    ...
    /**
     * Get the instance type the Executable is compiled for
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mInstanceType != other.mInstanceType){
        	return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + (this.mInstanceType != null ? this.mInstanceType.hashCode() : 0);//Amelie??
    ...
    public void toXML(XMLWriter writer, int indent) {
        if (mProfiles.isEmpty() && mPFNs.isEmpty() && mMetadata.isEmpty()) {
            ...
            if(mInstanceType != null){//Amelie
            	writer.writeAttribute("instancetype", mInstanceType.toString().toLowerCase());
            }
