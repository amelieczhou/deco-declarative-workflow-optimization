...
import edu.isi.pegasus.planner.catalog.transformation.classes.InstanceType;
...
public class TestTransformationCatalog {
    ...
    public static void main( String[] args ) {
        ...
        try{
            ...
            tce.setVDSSysInfo( new VDSSysInfo( Arch.INTEL32, Os.LINUX, InstanceType.SMALL, null, null ) ); //Amelie: what instance type?
